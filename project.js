...
if (path.includes("living")) {
  gallery = document.getElementById("livingGallery");
}

if (path.includes("bedroom")) {
  gallery = document.getElementById("bedroomGallery");
}

if (path.includes("bathroom")) {
  gallery = document.getElementById("bathroomGallery");
}

if (path.includes("hallway")) {
  gallery = document.getElementById("hallwayGallery");
}

if (path.includes("kids")) {
  gallery = document.getElementById("kidsGallery");
}
    ...
    if (!layoutBtn || !gallery) {
        return;
    }

    compactMode = false;
    gallery.classList.remove('compact');
