...
const defaultReviews = [
    {
        name: 'Айгерим',
        rating: 5,
        text: 'Очень понравился подход к работе. Всё было аккуратно, красиво и современно.',
        date: 'Недавно'
    },
    {
        name: 'Нурсултан',
        rating: 5,
        text: 'Сделали стильный интерьер и помогли с подбором материалов. Остались довольны результатом.',
        date: 'Недавно'
    }
];
...
function getReviews() {
    const saved = localStorage.getItem('archispaceReviews');
...
function saveReviews(reviews) {
    localStorage.setItem('archispaceReviews', JSON.stringify(reviews));
}
