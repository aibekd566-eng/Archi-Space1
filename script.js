...
function createMobileMenu() {
    ...
    mobileMenu.innerHTML = `
        <a href="#about" data-i18n="navAbout">${translations[currentLang].navAbout}</a>
        <a href="#services" data-i18n="navServices">${translations[currentLang].navServices}</a>
        <a href="#portfolio" data-i18n="navPortfolio">${translations[currentLang].navPortfolio}</a>
        <a href="#process" data-i18n="navProcess">${translations[currentLang].navProcess}</a>
        <a href="#contact" class="nav-cta" data-i18n="navContact">${translations[currentLang].navContact}</a>
    `;
...
if (floatingContact && floatingContactToggle) {
    ...
    window.addEventListener('scroll', () => {
        ...
        if (currentScroll > lastScrollTop && currentScroll > 200) {
            floatingContact.classList.add('hide-on-scroll');
        } else {
            floatingContact.classList.remove('hide-on-scroll');
        }
